...
private fun rsV111Ui(lang:RsLang,key:String):String{
    val en=mapOf(
        ...
        "backend" to "Cloud training data is unavailable. Check the connection or trainer permissions."
    )
    val nl=en+mapOf(
        ...
        "current_plan" to "Gekoppeld plan","backend" to "Cloud-trainingsgegevens zijn niet beschikbaar. Controleer de verbinding of trainerrechten."
    )
    val pt=en+mapOf(
        ...
        "current_plan" to "Plano atribuído","backend" to "Os dados de treino na cloud não estão disponíveis. Verifica a ligação ou as permissões do treinador."
    )
    val es=en+mapOf("files" to "Gestionar archivos guardados","hide_files" to "Ocultar archivos","no_files" to "Todavía no hay media registrada.","delete" to "Eliminar archivo","confirm" to "Confirmar eliminación","deleted" to "Archivo cloud eliminado.","delete_failed" to "No se pudo eliminar el archivo.","plan" to "Plan de entrenamiento de clase privada","plan_help" to "Vincula un plan reutilizable a esta clase privada confirmada. También aparecerá en las Tareas del alumno.","choose_plan" to "Elegir plan","due" to "Fecha / seguimiento","assign" to "Asignar plan","assigned" to "Plan asignado.","current_plan" to "Plan asignado","backend" to "Los datos de entrenamiento en la nube no están disponibles. Comprueba la conexión o los permisos del entrenador.")
    val fr=en+mapOf("files" to "Gérer les fichiers stockés","hide_files" to "Masquer les fichiers","no_files" to "Aucun média élève suivi.","delete" to "Supprimer le fichier","confirm" to "Confirmer","deleted" to "Fichier cloud supprimé.","delete_failed" to "Impossible de supprimer le fichier.","plan" to "Plan d’entraînement du cours privé","plan_help" to "Associe un plan réutilisable à ce cours privé confirmé. Il apparaîtra aussi dans les devoirs de l’élève.","choose_plan" to "Choisir le plan","due" to "Échéance / suivi","assign" to "Attribuer le plan","assigned" to "Plan attribué.","current_plan" to "Plan attribué","backend" to "Les données d’entraînement cloud sont indisponibles. Vérifie la connexion ou les autorisations de l’entraîneur.")
    val de=en+mapOf("files" to "Gespeicherte Dateien verwalten","hide_files" to "Dateien ausblenden","no_files" to "Noch keine erfassten Schülermedien.","delete" to "Datei löschen","confirm" to "Löschen bestätigen","deleted" to "Cloud-Datei gelöscht.","delete_failed" to "Cloud-Datei konnte nicht gelöscht werden.","plan" to "Trainingsplan Privatstunde","plan_help" to "Verknüpfe einen wiederverwendbaren Trainingsplan mit dieser bestätigten Privatstunde. Er erscheint auch bei den Hausaufgaben des Schülers.","choose_plan" to "Trainingsplan wählen","due" to "Fällig / Nachbereitung","assign" to "Plan zuweisen","assigned" to "Plan zugewiesen.","current_plan" to "Zugewiesener Plan","backend" to "Cloud-Trainingsdaten sind nicht verfügbar. Prüfe Verbindung oder Trainerberechtigungen.")
    val it=en+mapOf("files" to "Gestisci file salvati","hide_files" to "Nascondi file","no_files" to "Nessun media allievo tracciato.","delete" to "Elimina file","confirm" to "Conferma eliminazione","deleted" to "File cloud eliminato.","delete_failed" to "Impossibile eliminare il file.","plan" to "Piano lezione privata","plan_help" to "Collega un piano riutilizzabile a questa lezione privata confermata. Comparirà anche nei Compiti dell’allievo.","choose_plan" to "Scegli piano","due" to "Scadenza / follow-up","assign" to "Assegna piano","assigned" to "Piano assegnato.","current_plan" to "Piano assegnato","backend" to "I dati di allenamento cloud non sono disponibili. Controlla la connessione o i permessi dell’allenatore.")
    val pl=en+mapOf("files" to "Zarządzaj zapisanymi plikami","hide_files" to "Ukryj pliki","no_files" to "Brak śledzonych mediów ucznia.","delete" to "Usuń plik","confirm" to "Potwierdź usunięcie","deleted" to "Plik w chmurze usunięty.","delete_failed" to "Nie udało się usunąć pliku.","plan" to "Plan treningowy lekcji prywatnej","plan_help" to "Połącz wielokrotnego użytku plan treningowy z tą potwierdzoną lekcją prywatną. Pojawi się także w Zadaniach ucznia.","choose_plan" to "Wybierz plan","due" to "Termin / follow-up","assign" to "Przypisz plan","assigned" to "Plan przypisany.","current_plan" to "Przypisany plan","backend" to "Dane treningowe w chmurze są niedostępne. Sprawdź połączenie lub uprawnienia trenera.")
    val tr=en+mapOf("files" to "Saklanan dosyaları yönet","hide_files" to "Dosyaları gizle","no_files" to "Henüz takip edilen öğrenci medyası yok.","delete" to "Dosyayı sil","confirm" to "Silmeyi onayla","deleted" to "Bulut dosyası silindi.","delete_failed" to "Dosya silinemedi.","plan" to "Özel ders antrenman planı","plan_help" to "Yeniden kullanılabilir bir antrenman planını bu onaylı özel derse bağla. Öğrencinin Ödevler bölümünde de görünür.","choose_plan" to "Plan seç","due" to "Son tarih / takip","assign" to "Plan ata","assigned" to "Plan atandı.","current_plan" to "Atanan plan","backend" to "Bulut antrenman verileri kullanılamıyor. Bağlantıyı veya antrenör izinlerini kontrol et.")
