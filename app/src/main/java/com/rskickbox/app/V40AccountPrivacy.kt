...
private fun rsAccountUiV40(lang:RsLang,key:String):String{
    val en=mapOf(
        ...
        "delete_desc" to "Type DELETE to remove this offline test profile from this device. When cloud access is available, account deletion is requested securely from the RS KICKBOX backend.",
