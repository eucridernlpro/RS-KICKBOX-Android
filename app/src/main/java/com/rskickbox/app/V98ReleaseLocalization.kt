...
fun rsReleaseT98(lang:RsLang,key:String):String{
    val en=mapOf(
        ...
        "billing_sub" to "Your live membership and invoice history from RS KICKBOXING.",
        "sync_billing" to "Syncing billing…",
        "billing_connected" to "Cloud billing connected",
        "per_month" to "per month",
        "invoice_sub" to "Live invoice ledger synchronized with RS KICKBOXING cloud.",
    ...
    val nl=en+mapOf(
        ...
        "billing_sub" to "Je actuele lidmaatschap en factuurgeschiedenis van RS KICKBOXING.","sync_billing" to "Facturatie synchroniseren…","billing_connected" to "Cloudfacturatie verbonden","per_month" to "per maand",
        "invoice_sub" to "Live factuuroverzicht gesynchroniseerd met RS KICKBOXING cloud.","sync_invoices" to "Facturen synchroniseren…","invoice_connected" to "Cloudfacturen verbonden","invoice_paid" to "Factuur als betaald gemarkeerd.","invoice_pending" to "Factuur als openstaand gemarkeerd.",
    ...
    val pt=en+mapOf(
        ...
        "billing_sub" to "O teu histórico atual de adesão e faturas RS KICKBOXING.","sync_billing" to "A sincronizar faturação…","billing_connected" to "Faturação cloud ligada","per_month" to "por mês",
        "invoice_sub" to "Registo de faturas sincronizado com a cloud RS KICKBOXING.","sync_invoices" to "A sincronizar faturas…","invoice_connected" to "Faturas cloud ligadas","invoice_paid" to "Fatura marcada como paga.","invoice_pending" to "Fatura marcada como pendente.",
    ...
    val es=en+mapOf(
        ...
        "billing_sub" to "Tu historial actual de membresía y facturas de RS KICKBOXING.","sync_billing" to "Sincronizando facturación…","billing_connected" to "Facturación cloud conectada","per_month" to "al mes",
        "invoice_sub" to "Registro de facturas sincronizado con la cloud RS KICKBOXING.","sync_invoices" to "Sincronizando facturas…","invoice_connected" to "Facturas cloud conectadas","invoice_paid" to "Factura marcada como pagada.","invoice_pending" to "Factura marcada como pendiente.",
    ...
    val fr=en+mapOf(
        ...
        "billing_sub" to "Ton historique actuel d'adhésion et de factures RS KICKBOXING.","sync_billing" to "Synchronisation de la facturation…","billing_connected" to "Facturation cloud connectée","per_month" to "par mois",
        "invoice_sub" to "Registre de factures synchronisé avec le cloud RS KICKBOXING.","sync_invoices" to "Synchronisation des factures…","invoice_connected" to "Factures cloud connectées","invoice_paid" to "Facture marquée payée.","invoice_pending" to "Facture marquée en attente.",
    ...
    val de=en+mapOf(
        ...
        "billing_sub" to "Deine aktuelle RS KICKBOXING Mitgliedschafts- und Rechnungshistorie.","sync_billing" to "Abrechnung wird synchronisiert…","billing_connected" to "Cloud-Abrechnung verbunden","per_month" to "pro Monat",
        "invoice_sub" to "Live-Rechnungsübersicht mit der RS KICKBOXING Cloud synchronisiert.","sync_invoices" to "Rechnungen werden synchronisiert…","invoice_connected" to "Cloud-Rechnungen verbunden","invoice_paid" to "Rechnung als bezahlt markiert.","invoice_pending" to "Rechnung als offen markiert.",
    ...
    val it=en+mapOf(
        ...
        "billing_sub" to "Il tuo storico attuale di abbonamento e fatture RS KICKBOXING.","sync_billing" to "Sincronizzazione fatturazione…","billing_connected" to "Fatturazione cloud collegata","per_month" to "al mese",
        "invoice_sub" to "Registro fatture sincronizzato con la cloud RS KICKBOXING.","sync_invoices" to "Sincronizzazione fatture…","invoice_connected" to "Fatture cloud collegate","invoice_paid" to "Fattura segnata come pagata.","invoice_pending" to "Fattura segnata come in attesa.",
    ...
    val pl=en+mapOf(
        ...
        "billing_sub" to "Twoja aktualna historia członkostwa i faktur RS KICKBOXING.","sync_billing" to "Synchronizacja rozliczeń…","billing_connected" to "Rozliczenia w chmurze połączone","per_month" to "miesięcznie",
        "invoice_sub" to "Rejestr faktur zsynchronizowany z chmurą RS KICKBOXING.","sync_invoices" to "Synchronizacja faktur…","invoice_connected" to "Faktury w chmurze połączone","invoice_paid" to "Faktura oznaczona jako opłacona.","invoice_pending" to "Faktura oznaczona jako oczekująca.",
    ...
    val tr=en+mapOf(
        ...
        "billing_sub" to "Güncel RS KICKBOXING üyelik ve fatura geçmişiniz.","sync_billing" to "Faturalama eşitleniyor…","billing_connected" to "Bulut faturalama bağlı","per_month" to "aylık",
        "invoice_sub" to "Canlı fatura kaydı RS KICKBOXING bulutuyla eşitlenmiştir.","sync_invoices" to "Faturalar eşitleniyor…","invoice_connected" to "Bulut faturaları bağlı","invoice_paid" to "Fatura ödendi olarak işaretlendi.","invoice_pending" to "Fatura beklemede olarak işaretlendi.",
