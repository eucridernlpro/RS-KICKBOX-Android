...
private fun rsServiceUiV51(lang:RsLang,key:String):String{
    val en=mapOf(
        ...
        "support" to "Support","support_sub" to "Send a private support request to the RS KICKBOXING team.",
        "support_admin" to "Support Inbox","support_admin_sub" to "Review and answer member support requests.",
        "referrals" to "Referrals","referrals_sub" to "Share RS KICKBOXING with someone you know.",
            ...
            Button(
                onClick={
                    val intent=android.content.Intent(android.content.Intent.ACTION_SEND).apply{
                        type="text/plain"
                        putExtra(android.content.Intent.EXTRA_TEXT,"Join RS KICKBOXING with referral code "+referral.code+"\n"+RS_PLAY_STORE_URL_V33)
                    }
                    context.startActivity(android.content.Intent.createChooser(intent,"Share RS KICKBOXING referral"))
                },
                    ...
                    Button(
                        onClick={
                            val shareText=when(lang.code){
                                "nl"->"Word lid van RS KICKBOXING met referralcode "
                                "pt"->"Junta-te à RS KICKBOXING com o código de referência "
                                "es"->"Únete a RS KICKBOXING con el código de referido "
                                "fr"->"Rejoins RS KICKBOXING avec le code de parrainage "
                                "de"->"Tritt RS KICKBOXING mit diesem Empfehlungscode bei: "
                                "it"->"Unisciti a RS KICKBOXING con il codice referral "
                                "pl"->"Dołącz do RS KICKBOXING z kodem polecającym "
                                "tr"->"RS KICKBOXING'a şu referans koduyla katıl: "
                                else->"Join RS KICKBOXING with referral code "
                            }
                            val intent=android.content.Intent(android.content.Intent.ACTION_SEND).apply{
                                type="text/plain"
