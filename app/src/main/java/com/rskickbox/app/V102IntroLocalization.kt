...
fun rsIntroT102(lang:RsLang,key:String):String{
    val en=mapOf(
        ...
        "phone" to "PHONE SPLASH VIDEO","tablet" to "TABLET SPLASH VIDEO","phone_format" to "Recommended: portrait 9:16 · 1080×1920 or similar · MP4 H.264 · 17 sec max","tablet_format" to "Recommended: tablet 16:10 or 4:3 · minimum 1600px long edge · MP4 H.264 · 17 sec max. Auto-crops to screen.",
        ...
        "too_long" to "Video rejected. Maximum splash length is 17 seconds.",
    ...
    val nl=en+mapOf(
        ...
        "phone" to "TELEFOON SPLASHVIDEO","tablet" to "TABLET SPLASHVIDEO","phone_format" to "Aanbevolen: portret 9:16 · 1080×1920 of vergelijkbaar · MP4 H.264 · max. 17 sec","tablet_format" to "Aanbevolen: tablet 16:10 of 4:3 · lange zijde min. 1600px · MP4 H.264 · max. 17 sec. Automatisch bijgesneden.","gallery" to "Galerij","replace" to "Vervangen","files" to "Bestanden",
        "pending" to "PREVIEW — NOG NIET OPGESLAGEN","saved" to "OPGESLAGEN SPLASHVIDEO","duration" to "Duur","max" to "max. 17,00 sec",
    ...
    val pt=en+mapOf(
        ...
        "phone" to "SPLASH TELEMÓVEL","tablet" to "SPLASH TABLET","phone_format" to "Recomendado: vertical 9:16 · 1080×1920 ou semelhante · MP4 H.264 · máx. 17 s","tablet_format" to "Recomendado: tablet 16:10 ou 4:3 · mínimo 1600px no lado maior · MP4 H.264 · máx. 17 s. Recorte automático.","gallery" to "Galeria","replace" to "Substituir","files" to "Ficheiros","pending" to "PRÉ-VISUALIZAÇÃO — NÃO GUARDADO","saved" to "SPLASH GUARDADO",
        "duration" to "Duração","max" to "máx. 17,00 s","test" to "▶ Testar splash em ecrã completo","optimizing" to "A otimizar vídeo…","save" to "✓ Guardar / Aceitar splash","cancel" to "Cancelar edição","delete" to "Eliminar splash guardado",
    ...
    val es=en+mapOf(
        ...
        "phone" to "SPLASH MÓVIL","tablet" to "SPLASH TABLET","phone_format" to "Recomendado: vertical 9:16 · 1080×1920 o similar · MP4 H.264 · máx. 17 s","tablet_format" to "Recomendado: tablet 16:10 o 4:3 · mínimo 1600px lado largo · MP4 H.264 · máx. 17 s. Recorte automático.","gallery" to "Galería","replace" to "Reemplazar","files" to "Archivos","pending" to "VISTA PREVIA — NO GUARDADO","saved" to "SPLASH GUARDADO",
        "duration" to "Duración","max" to "máx. 17,00 s","test" to "▶ Probar splash a pantalla completa","optimizing" to "Optimizando vídeo…","save" to "✓ Guardar / Aceptar splash","cancel" to "Cancelar edición","delete" to "Eliminar splash guardado",
    ...
    val fr=en+mapOf(
        ...
        "phone" to "SPLASH TÉLÉPHONE","tablet" to "SPLASH TABLETTE","phone_format" to "Recommandé : portrait 9:16 · 1080×1920 ou similaire · MP4 H.264 · 17 s max","tablet_format" to "Recommandé : tablette 16:10 ou 4:3 · bord long min. 1600px · MP4 H.264 · 17 s max. Recadrage auto.","gallery" to "Galerie","replace" to "Remplacer","files" to "Fichiers","pending" to "APERÇU — NON ENREGISTRÉ","saved" to "SPLASH ENREGISTRÉ",
        "duration" to "Durée","max" to "17,00 s max","test" to "▶ Tester en plein écran","optimizing" to "Optimisation de la vidéo…","save" to "✓ Enregistrer / Accepter","cancel" to "Annuler","delete" to "Supprimer le splash",
    ...
    val de=en+mapOf(
        ...
        "phone" to "TELEFON-SPLASHVIDEO","tablet" to "TABLET-SPLASHVIDEO","phone_format" to "Empfohlen: Hochformat 9:16 · 1080×1920 oder ähnlich · MP4 H.264 · max. 17 Sek.","tablet_format" to "Empfohlen: Tablet 16:10 oder 4:3 · lange Seite min. 1600px · MP4 H.264 · max. 17 Sek. Auto-Zuschnitt.","gallery" to "Galerie","replace" to "Ersetzen","files" to "Dateien",
        "pending" to "VORSCHAU — NOCH NICHT GESPEICHERT","saved" to "GESPEICHERTES SPLASHVIDEO","duration" to "Dauer","max" to "max. 17,00 Sek.",
        ...
        "too_long" to "Video abgelehnt. Maximale Splash-Dauer: 17 Sekunden.","phone_synced" to "Telefon-Splash gespeichert und mit der Cloud synchronisiert.","tablet_synced" to "Tablet-Splash gespeichert und mit der Cloud synchronisiert.",
    ...
    val it=en+mapOf(
        ...
        "phone" to "SPLASH TELEFONO","tablet" to "SPLASH TABLET","phone_format" to "Consigliato: verticale 9:16 · 1080×1920 o simile · MP4 H.264 · max 17 sec","tablet_format" to "Consigliato: tablet 16:10 o 4:3 · lato lungo min. 1600px · MP4 H.264 · max 17 sec. Ritaglio automatico.","gallery" to "Galleria","replace" to "Sostituisci","files" to "File",
        "pending" to "ANTEPRIMA — NON ANCORA SALVATA","saved" to "VIDEO SPLASH SALVATO","duration" to "Durata","max" to "max 17,00 sec",
        ...
        "too_long" to "Video rifiutato. Durata massima splash: 17 secondi.","phone_synced" to "Splash telefono salvato e sincronizzato nel cloud.","tablet_synced" to "Splash tablet salvato e sincronizzato nel cloud.",
    ...
    val pl=en+mapOf(
        ...
        "phone" to "SPLASH TELEFON","tablet" to "SPLASH TABLET","phone_format" to "Zalecane: pion 9:16 · 1080×1920 lub podobne · MP4 H.264 · maks. 17 s","tablet_format" to "Zalecane: tablet 16:10 lub 4:3 · dłuższy bok min. 1600px · MP4 H.264 · maks. 17 s. Automatyczne kadrowanie.","gallery" to "Galeria","replace" to "Zastąp","files" to "Pliki",
        "pending" to "PODGLĄD — JESZCZE NIE ZAPISANO","saved" to "ZAPISANE WIDEO SPLASH","duration" to "Czas trwania","max" to "maks. 17,00 s",
        ...
        "too_long" to "Film odrzucony. Maksymalna długość splash to 17 sekund.","phone_synced" to "Splash telefonu zapisany i zsynchronizowany z chmurą.","tablet_synced" to "Splash tabletu zapisany i zsynchronizowany z chmurą.",
    ...
    val tr=en+mapOf(
        ...
        "phone" to "TELEFON SPLASH","tablet" to "TABLET SPLASH","phone_format" to "Önerilen: dikey 9:16 · 1080×1920 veya benzeri · MP4 H.264 · en fazla 17 sn","tablet_format" to "Önerilen: tablet 16:10 veya 4:3 · uzun kenar en az 1600px · MP4 H.264 · en fazla 17 sn. Otomatik kırpılır.","gallery" to "Galeri","replace" to "Değiştir","files" to "Dosyalar",
        "pending" to "ÖNİZLEME — HENÜZ KAYDEDİLMEDİ","saved" to "KAYDEDİLMİŞ SPLASH VİDEOSU","duration" to "Süre","max" to "en fazla 17,00 sn",
        ...
        "too_long" to "Video reddedildi. Maksimum splash süresi 17 saniyedir.","phone_synced" to "Telefon splashı kaydedildi ve bulutla eşitlendi.","tablet_synced" to "Tablet splashı kaydedildi ve bulutla eşitlendi.",
