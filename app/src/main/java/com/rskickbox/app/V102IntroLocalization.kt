...
fun rsIntroT102(lang:RsLang,key:String):String{
    ...
    val pt=en+mapOf(
        ...
        "phone" to "SPLASH TELEMÓVEL","tablet" to "SPLASH TABLET","phone_format" to "Recomendado: vertical 9:16 · 1080×1920 ou semelhante · MP4 H.264 · máx. 15 s","tablet_format" to "Recomendado: tablet 16:10 ou 4:3 · mínimo 1600px no lado maior · MP4 H.264 · máx. 15 s. Recorte automático.","gallery" to "Galeria","replace" to "Substituir","files" to "Ficheiros","pending" to "PRÉ-VISUALIZAÇÃO — NÃO GUARDADO","saved" to "SPLASH GUARDADO",
    ...
    val es=en+mapOf(
        ...
        "phone" to "SPLASH MÓVIL","tablet" to "SPLASH TABLET","phone_format" to "Recomendado: vertical 9:16 · 1080×1920 o similar · MP4 H.264 · máx. 15 s","tablet_format" to "Recomendado: tablet 16:10 o 4:3 · mínimo 1600px lado largo · MP4 H.264 · máx. 15 s. Recorte automático.","gallery" to "Galería","replace" to "Reemplazar","files" to "Archivos","pending" to "VISTA PREVIA — NO GUARDADO","saved" to "SPLASH GUARDADO",
    ...
    val fr=en+mapOf(
        ...
        "phone" to "SPLASH TÉLÉPHONE","tablet" to "SPLASH TABLETTE","phone_format" to "Recommandé : portrait 9:16 · 1080×1920 ou similaire · MP4 H.264 · 15 s max","tablet_format" to "Recommandé : tablette 16:10 ou 4:3 · bord long min. 1600px · MP4 H.264 · 15 s max. Recadrage auto.","gallery" to "Galerie","replace" to "Remplacer","files" to "Fichiers","pending" to "APERÇU — NON ENREGISTRÉ","saved" to "SPLASH ENREGISTRÉ",
    ...
    val de=en+mapOf(
        ...
        "phone" to "TELEFON-SPLASHVIDEO","tablet" to "TABLET-SPLASHVIDEO","phone_format" to "Empfohlen: Hochformat 9:16 · 1080×1920 oder ähnlich · MP4 H.264 · max. 15 Sek.","tablet_format" to "Empfohlen: Tablet 16:10 oder 4:3 · lange Seite min. 1600px · MP4 H.264 · max. 15 Sek. Auto-Zuschnitt.","gallery" to "Galerie","replace" to "Ersetzen","files" to "Dateien",
    ...
    val it=en+mapOf(
        ...
        "phone" to "SPLASH TELEFONO","tablet" to "SPLASH TABLET","phone_format" to "Consigliato: verticale 9:16 · 1080×1920 o simile · MP4 H.264 · max 15 sec","tablet_format" to "Consigliato: tablet 16:10 o 4:3 · lato lungo min. 1600px · MP4 H.264 · max 15 sec. Ritaglio automatico.","gallery" to "Galleria","replace" to "Sostituisci","files" to "File",
    ...
    val pl=en+mapOf(
        ...
        "phone" to "SPLASH TELEFON","tablet" to "SPLASH TABLET","phone_format" to "Zalecane: pion 9:16 · 1080×1920 lub podobne · MP4 H.264 · maks. 15 s","tablet_format" to "Zalecane: tablet 16:10 lub 4:3 · dłuższy bok min. 1600px · MP4 H.264 · maks. 15 s. Automatyczne kadrowanie.","gallery" to "Galeria","replace" to "Zastąp","files" to "Pliki",
    ...
    val tr=en+mapOf(
        ...
        "phone" to "TELEFON SPLASH","tablet" to "TABLET SPLASH","phone_format" to "Önerilen: dikey 9:16 · 1080×1920 veya benzeri · MP4 H.264 · en fazla 15 sn","tablet_format" to "Önerilen: tablet 16:10 veya 4:3 · uzun kenar en az 1600px · MP4 H.264 · en fazla 15 sn. Otomatik kırpılır.","gallery" to "Galeri","replace" to "Değiştir","files" to "Dosyalar",
