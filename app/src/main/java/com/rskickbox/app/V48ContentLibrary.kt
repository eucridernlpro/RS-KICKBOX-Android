...
private fun rsContentUiV48(lang:RsLang,key:String):String{
    val en=mapOf(
        ...
        "vault" to "Knowledge Vault","vault_sub" to "Your unlocked RS KICKBOXING training library.",
...
private fun RsCloudContentBrowserV79(c:RsPalette,lang:RsLang,mode:String){
    ...
    val subtitle=when(mode){
        ...
        else->"Your live RS KICKBOXING training library, filtered by membership access."
    }
