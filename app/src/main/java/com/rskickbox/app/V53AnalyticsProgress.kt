...
private fun rsAnalyticsUiV53(lang:RsLang,key:String):String{
    val en=mapOf(
        "analytics" to "Analytics","analytics_sub" to "Live local operating metrics from the connected RS KICKBOXING modules.",
