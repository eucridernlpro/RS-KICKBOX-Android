...
fun rsEnrollmentT(lang:RsLang,key:String):String{
    val en=mapOf(
        ...
        "trainer_preview" to "Trainer / Admin preview",
        "build_label" to "v0.51 PRIVATE ENROLLMENT QC BUILD",
