...
private val routeTitlesV25=mapOf(
    ...
    "home_training" to listOf("Workout & Home Training","Workout & Thuis Training","Treino & Treino em Casa","Entreno & Entrenamiento en Casa","Workout & Entraînement Maison","Workout & Heimtraining","Workout & Allenamento a Casa","Workout & Trening Domowy","Workout & Ev Antrenmanı"),
    ...
    "coachchat" to listOf("RS Chat","RS Chat","Chat RS","Chat RS","Chat RS","RS Chat","Chat RS","RS Chat","RS Chat"),
    ...
    "privacy_admin" to listOf("Privacy Requests","Privacyverzoeken","Pedidos de Privacidade","Solicitudes de Privacidad","Demandes de Confidentialité","Datenschutzanfragen","Richieste Privacy","Wnioski Prywatności","Gizlilik İstekleri"),
...
private val routeHintsV25=mapOf(
    ...
    "techniques" to listOf("Moves · drills · details","Technieken · drills · details","Técnicas · exercícios · detalhes","Técnicas · ejercicios · detalles","Techniques · exercices · détails","Techniken · Drills · Details","Tecniche · esercizi · dettagli","Techniki · ćwiczenia · szczegóły","Teknikler · alıştırmalar · detaylar"),
    "home_training" to listOf("Train anywhere","Train overal","Treina em qualquer lugar","Entrena en cualquier lugar","Entraîne-toi partout","Überall trainieren","Allenati ovunque","Trenuj wszędzie","Her yerde antrenman"),
    "workout" to listOf("Build your session","Bouw je training","Cria a tua sessão","Crea tu sesión","Crée ta séance","Training erstellen","Crea la tua sessione","Zbuduj sesję","Seansını oluştur"),
    "classes" to listOf("Schedule · capacity · booking","Schema · capaciteit · boeken","Horário · capacidade · reservas","Horario · capacidad · reservas","Planning · capacité · réservations","Plan · Kapazität · Buchung","Orari · capacità · prenotazioni","Grafik · miejsca · rezerwacje","Program · kapasite · rezervasyon"),
    "events" to listOf("Seminars · club days · RSVP","Seminars · clubdagen · RSVP","Seminários · dias do clube · RSVP","Seminarios · días del club · RSVP","Séminaires · journées club · RSVP","Seminare · Clubtage · RSVP","Seminari · giornate club · RSVP","Seminaria · dni klubu · RSVP","Seminerler · kulüp günleri · RSVP"),
    "coachchat" to listOf("Private trainer messages","Privéberichten met trainer","Mensagens privadas com treinador","Mensajes privados con entrenador","Messages privés entraîneur","Private Trainer-Nachrichten","Messaggi privati trainer","Prywatne wiadomości trenera","Özel antrenör mesajları"),
    "community" to listOf("Club feed · connection","Clubfeed · verbinding","Feed do clube · ligação","Feed del club · conexión","Fil du club · connexion","Club-Feed · Verbindung","Feed club · connessione","Kanał klubu · kontakt","Kulüp akışı · bağlantı"),
    "groups" to listOf("Team spaces","Teamruimtes","Espaços de equipa","Espacios de equipo","Espaces d’équipe","Team-Bereiche","Spazi squadra","Przestrzenie zespołu","Takım alanları"),
    "private_lessons" to listOf("1-to-1 coaching","1-op-1 coaching","Coaching individual","Coaching 1 a 1","Coaching individuel","1-zu-1 Coaching","Coaching individuale","Coaching 1 na 1","Bire bir coaching"),
    "progress" to listOf("Scores · history · development","Scores · historie · ontwikkeling","Pontuações · histórico · evolução","Puntuaciones · historial · desarrollo","Scores · historique · progression","Werte · Verlauf · Entwicklung","Punteggi · storico · sviluppo","Wyniki · historia · rozwój","Puanlar · geçmiş · gelişim"),
    "challenges" to listOf("Goals · consistency","Doelen · consistentie","Objetivos · consistência","Objetivos · constancia","Objectifs · régularité","Ziele · Konstanz","Obiettivi · costanza","Cele · regularność","Hedefler · istikrar"),
    "badges" to listOf("Achievements · milestones","Prestaties · mijlpalen","Conquistas · marcos","Logros · hitos","Réussites · étapes","Erfolge · Meilensteine","Traguardi · tappe","Osiągnięcia · kamienie milowe","Başarılar · dönüm noktaları"),
    "fightcamp" to listOf("8-week preparation","8-weekse voorbereiding","Preparação de 8 semanas","Preparación de 8 semanas","Préparation sur 8 semaines","8-Wochen-Vorbereitung","Preparazione di 8 settimane","8-tygodniowe przygotowanie","8 haftalık hazırlık"),
    "compare" to listOf("Compare movement","Vergelijk beweging","Compara movimento","Compara movimiento","Compare le mouvement","Bewegung vergleichen","Confronta movimento","Porównaj ruch","Hareket karşılaştır"),
    "history" to listOf("Recently opened content","Recent geopende content","Conteúdo aberto recentemente","Contenido abierto recientemente","Contenu récemment ouvert","Zuletzt geöffnete Inhalte","Contenuti aperti di recente","Ostatnio otwarte treści","Son açılan içerikler"),
    "vault" to listOf("Unlocked training library","Vrijgegeven trainingsbibliotheek","Biblioteca de treino desbloqueada","Biblioteca de entrenamiento desbloqueada","Bibliothèque d’entraînement débloquée","Freigeschaltete Trainingsbibliothek","Libreria allenamento sbloccata","Odblokowana biblioteka treningowa","Açık antrenman kütüphanesi"),
    "homework" to listOf("Coach assignments","Coachopdrachten","Tarefas do treinador","Tareas del entrenador","Devoirs du coach","Traineraufgaben","Compiti del trainer","Zadania trenera","Antrenör ödevleri"),
    "favorites" to listOf("Saved training content","Opgeslagen trainingscontent","Conteúdo de treino guardado","Contenido guardado","Contenu d’entraînement enregistré","Gespeicherte Trainingsinhalte","Contenuti salvati","Zapisane treści treningowe","Kaydedilen antrenman içeriği"),
    "media" to listOf("Videos · uploads","Video’s · uploads","Vídeos · carregamentos","Vídeos · subidas","Vidéos · imports","Videos · Uploads","Video · caricamenti","Wideo · przesyłanie","Videolar · yüklemeler"),
    "book" to listOf("Preview · full reader · Amazon","Preview · volledige reader · Amazon","Prévia · leitor completo · Amazon","Vista previa · lector completo · Amazon","Aperçu · lecteur complet · Amazon","Vorschau · Vollreader · Amazon","Anteprima · lettore completo · Amazon","Podgląd · pełny czytnik · Amazon","Önizleme · tam okuyucu · Amazon"),
    "profile" to listOf("Goals · identity · privacy","Doelen · identiteit · privacy","Objetivos · identidade · privacidade","Objetivos · identidad · privacidad","Objectifs · identité · confidentialité","Ziele · Identität · Datenschutz","Obiettivi · identità · privacy","Cele · tożsamość · prywatność","Hedefler · kimlik · gizlilik"),
    "search" to listOf("Find training content","Vind trainingscontent","Encontra conteúdo de treino","Encuentra contenido de entrenamiento","Trouve du contenu d’entraînement","Trainingsinhalte finden","Trova contenuti di allenamento","Znajdź treści treningowe","Antrenman içeriği bul"),
    "themes" to listOf("Complete app identity","Volledige app-identiteit","Identidade completa da app","Identidad completa de la app","Identité complète de l’app","Komplette App-Identität","Identità completa app","Pełna identyfikacja aplikacji","Tam uygulama kimliği"),
    "backgrounds" to listOf("Pages · cards · banners","Pagina’s · kaarten · banners","Páginas · cartões · banners","Páginas · tarjetas · banners","Pages · cartes · bannières","Seiten · Karten · Banner","Pagine · schede · banner","Strony · karty · banery","Sayfalar · kartlar · bannerlar"),
    "branding" to listOf("Logo · name · visual identity","Logo · naam · visuele identiteit","Logo · nome · identidade visual","Logo · nombre · identidad visual","Logo · nom · identité visuelle","Logo · Name · visuelle Identität","Logo · nome · identità visiva","Logo · nazwa · identyfikacja","Logo · ad · görsel kimlik"),
    "intro_settings" to listOf("Phone · tablet · splash video","Telefoon · tablet · splashvideo","Telemóvel · tablet · vídeo splash","Teléfono · tablet · vídeo splash","Téléphone · tablette · vidéo splash","Telefon · Tablet · Splash-Video","Telefono · tablet · video splash","Telefon · tablet · wideo startowe","Telefon · tablet · açılış videosu"),
    "landing_admin" to listOf("Clickable promos · book campaign","Klikbare promo’s · boekcampagne","Promoções clicáveis · campanha do livro","Promos clicables · campaña del libro","Promos cliquables · campagne livre","Klickbare Promos · Buchkampagne","Promo cliccabili · campagna libro","Klikalne promocje · kampania książki","Tıklanabilir promosyonlar · kitap kampanyası"),
    "lesson_editor" to listOf("Academy content","Academy-content","Conteúdo da Academia","Contenido de Academia","Contenu Académie","Academy-Inhalte","Contenuti Academy","Treści Akademii","Akademi içeriği"),
    "content" to listOf("Lessons · cards · searchable library","Lessen · kaarten · zoekbibliotheek","Aulas · cartões · biblioteca pesquisável","Lecciones · tarjetas · biblioteca buscable","Leçons · cartes · bibliothèque","Lektionen · Karten · Suchbibliothek","Lezioni · schede · libreria","Lekcje · karty · biblioteka","Dersler · kartlar · aranabilir kütüphane"),
    "homework_admin" to listOf("Assign · review · completion","Toewijzen · bekijken · voltooiing","Atribuir · rever · conclusão","Asignar · revisar · completar","Attribuer · revoir · terminer","Zuweisen · prüfen · Abschluss","Assegna · verifica · completamento","Przydziel · sprawdź · ukończenie","Ata · incele · tamamlama"),
    "session_builder" to listOf("Reusable timed training plans","Herbruikbare getimede plannen","Planos temporizados reutilizáveis","Planes cronometrados reutilizables","Plans chronométrés réutilisables","Wiederverwendbare Zeitpläne","Piani temporizzati riutilizzabili","Wielorazowe plany czasowe","Yeniden kullanılabilir zamanlı planlar"),
    "music_admin" to listOf("Device music · internal player","Apparaatmuziek · interne speler","Música do dispositivo · leitor interno","Música del dispositivo · reproductor","Musique appareil · lecteur interne","Gerätemusik · interner Player","Musica dispositivo · player interno","Muzyka urządzenia · odtwarzacz","Cihaz müziği · dahili oynatıcı"),
    "notes" to listOf("Private trainer observations","Privé trainerobservaties","Observações privadas do treinador","Observaciones privadas del entrenador","Observations privées entraîneur","Private Trainernotizen","Osservazioni private trainer","Prywatne notatki trenera","Özel antrenör notları"),
    "members" to listOf("Profiles · status · invitations","Profielen · status · uitnodigingen","Perfis · estado · convites","Perfiles · estado · invitaciones","Profils · statut · invitations","Profile · Status · Einladungen","Profili · stato · inviti","Profile · status · zaproszenia","Profiller · durum · davetler"),
    "access" to listOf("Plans · activation · access","Plannen · activatie · toegang","Planos · ativação · acesso","Planes · activación · acceso","Formules · activation · accès","Pläne · Aktivierung · Zugriff","Piani · attivazione · accesso","Plany · aktywacja · dostęp","Planlar · etkinleştirme · erişim"),
    "plans_admin" to listOf("Pricing · availability · descriptions","Prijzen · beschikbaarheid · beschrijvingen","Preços · disponibilidade · descrições","Precios · disponibilidad · descripciones","Prix · disponibilité · descriptions","Preise · Verfügbarkeit · Beschreibungen","Prezzi · disponibilità · descrizioni","Ceny · dostępność · opisy","Fiyat · kullanılabilirlik · açıklamalar"),
    "progress_admin" to listOf("Assessments · homework · challenges","Beoordelingen · huiswerk · challenges","Avaliações · tarefas · desafios","Evaluaciones · tareas · desafíos","Évaluations · devoirs · défis","Bewertungen · Hausaufgaben · Challenges","Valutazioni · compiti · sfide","Oceny · zadania · wyzwania","Değerlendirmeler · ödevler · görevler"),
    "assessments" to listOf("Scores · coaching feedback","Scores · coachfeedback","Pontuações · feedback","Puntuaciones · feedback","Scores · feedback","Werte · Coaching-Feedback","Punteggi · feedback","Wyniki · feedback","Puanlar · geri bildirim"),
    "challenge_admin" to listOf("Student goals · progress","Leerlingdoelen · voortgang","Objetivos do aluno · progresso","Objetivos del alumno · progreso","Objectifs élève · progression","Schülerziele · Fortschritt","Obiettivi allievo · progresso","Cele ucznia · postęp","Öğrenci hedefleri · ilerleme"),
    "fightcamp_admin" to listOf("8-week camp planning","8-weekse campplanning","Planeamento de camp 8 semanas","Planificación camp 8 semanas","Planification camp 8 semaines","8-Wochen-Campplanung","Pianificazione camp 8 settimane","Planowanie campu 8 tygodni","8 haftalık camp planlama"),
    "attendance" to listOf("Present · absent · class record","Aanwezig · afwezig · lesregistratie","Presente · ausente · registo","Presente · ausente · registro","Présent · absent · registre","Anwesend · abwesend · Liste","Presente · assente · registro","Obecny · nieobecny · zapis","Var · yok · ders kaydı"),
    "qr_attendance" to listOf("Fast class check-in","Snelle les check-in","Check-in rápido na aula","Check-in rápido de clase","Check-in rapide du cours","Schneller Kurs-Check-in","Check-in rapido lezione","Szybki check-in na zajęcia","Hızlı ders check-in"),
    "events_admin" to listOf("Events · capacity · RSVP","Evenementen · capaciteit · RSVP","Eventos · capacidade · RSVP","Eventos · capacidad · RSVP","Événements · capacité · RSVP","Events · Kapazität · RSVP","Eventi · capacità · RSVP","Wydarzenia · miejsca · RSVP","Etkinlikler · kapasite · RSVP"),
    "schedule" to listOf("Private slots · requests","Privéslots · verzoeken","Horários privados · pedidos","Horarios privados · solicitudes","Créneaux privés · demandes","Private Slots · Anfragen","Slot privati · richieste","Prywatne terminy · prośby","Özel saatler · talepler"),
    "payments" to listOf("Methods · instructions · ledger","Methoden · instructies · overzicht","Métodos · instruções · registo","Métodos · instrucciones · registro","Méthodes · instructions · registre","Methoden · Anweisungen · Übersicht","Metodi · istruzioni · registro","Metody · instrukcje · rejestr","Yöntemler · talimatlar · kayıt"),
    "invoices" to listOf("Revenue · status · due dates","Omzet · status · vervaldatums","Receita · estado · vencimentos","Ingresos · estado · vencimientos","Revenus · statut · échéances","Umsatz · Status · Fälligkeit","Ricavi · stato · scadenze","Przychód · status · terminy","Gelir · durum · vadeler"),
    "analytics" to listOf("Students · revenue · occupancy","Leerlingen · omzet · bezetting","Alunos · receita · ocupação","Alumnos · ingresos · ocupación","Élèves · revenus · occupation","Schüler · Umsatz · Auslastung","Allievi · ricavi · occupazione","Uczniowie · przychód · obłożenie","Öğrenciler · gelir · doluluk"),
    "release" to listOf("Policies · backend · store readiness","Beleid · backend · store-gereedheid","Políticas · backend · preparação da loja","Políticas · backend · preparación tienda","Politiques · backend · préparation store","Richtlinien · Backend · Store-Bereitschaft","Policy · backend · preparazione store","Polityki · backend · gotowość sklepu","Politikalar · backend · mağaza hazırlığı"),
    "privacy_admin" to listOf("Data export · account deletion","Data-export · accountverwijdering","Exportação de dados · eliminação de conta","Exportación de datos · eliminación de cuenta","Export de données · suppression de compte","Datenexport · Kontolöschung","Esportazione dati · eliminazione account","Eksport danych · usunięcie konta","Veri dışa aktarma · hesap silme")
)
...
fun rsEnrollmentT(lang:RsLang,key:String):String{
    val en=mapOf(
        ...
        "trainer_preview" to "Trainer / Admin preview",
        "build_label" to "RS KICKBOXING · SECURE PRIVATE ACCESS",
        "student_manager" to "Student Manager",
        "student_manager_sub" to "Create private RS KICKBOXING student accounts, generate invitation QR codes and manage access.",
...
fun rsEnrollMsg(lang:RsLang,key:String,name:String="",detail:String=""):String{
    val en=mapOf(
        "invalid_qr" to "This QR is not a valid RS KICKBOXING student invitation.",
        "invite_loaded" to "Invitation loaded for {name} · {detail}. You can now log in.",
        "qr_unreadable" to "No readable RS KICKBOXING QR code was found in this image.",
