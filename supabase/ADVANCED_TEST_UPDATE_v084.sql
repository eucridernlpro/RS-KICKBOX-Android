-- RS KICKBOX ADVANCED TEST BACKEND UPDATE v0.84
-- Run this ONCE in Supabase SQL Editor on an existing RS KICKBOX project
-- that already has the original base schema installed.
-- The statements are designed to be rerunnable where possible.
