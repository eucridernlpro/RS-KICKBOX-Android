...
-- This delta intentionally contains migrations 0040-0044:
-- global brand settings, shared visual assets, shared intro/splash settings,
-- cloud promotions/book management, and the server-side Technique Coach AI usage quota.
