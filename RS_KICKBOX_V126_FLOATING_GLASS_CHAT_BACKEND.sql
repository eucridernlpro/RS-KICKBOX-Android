-- RS KICKBOXING v0.126 FLOATING GLASS CHAT BACKEND
-- Presence, online/offline contacts, common file attachments and unified chat support. Safe to run more than once.
